...
public class AreaAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View inflate = View.inflate(MyApplication.getContextObject(), R.layout.item_area, null);
        TextView area = (TextView) inflate.findViewById(R.id.area);
        area.setText(mData.get(i));

        // 只有当更新的位置等于当前位置时，更改颜色
        if (mCurrentItem == i && isClick) {
            area.setTextColor(Color.RED);
        } else {
