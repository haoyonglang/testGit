...
public class StreetAdapter extends BaseAdapter {
    ...
    public StreetAdapter(List<String> data) {
        this.mData = data;
        for (int i = 0; i < 20; i++) {
            mData.add("街道：" + i);
        }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View inflate = View.inflate(MyApplication.getContextObject(), R.layout.item_street, null);
        TextView street = (TextView) inflate.findViewById(R.id.street);
        street.setText(mData.get(i));
