...
public class GuideActivity extends AppCompatActivity {
     ...
     * 功能引导页展示的图片集合
     */
    private static int[] mImageIds = new int[]{R.mipmap.ic_guide_1,
            R.mipmap.ic_guide_2, R.mipmap.ic_guide_3};
...
//        mDotDistance = mDotGroup.getChildAt(1).getLeft() - mDotGroup.getChildAt(0).getLeft();
        ...
        mBtnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharePreferenceUtils.setBoolean(GuideActivity.this, SharePreferenceUtils.GUIDE_SHOWED, true);
                // 跳转到主页面
